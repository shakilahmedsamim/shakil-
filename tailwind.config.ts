...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "hero-desktop": ["56px", { lineHeight: "1.12", letterSpacing: "-0.02em", fontWeight: "600" }],
        "hero-mobile": ["34px", { lineHeight: "1.12", letterSpacing: "-0.02em", fontWeight: "600" }],
        "h2-desktop": ["40px", { lineHeight: "1.22", letterSpacing: "-0.02em", fontWeight: "600" }],
        "h2-mobile": ["28px", { lineHeight: "1.22", letterSpacing: "-0.02em", fontWeight: "600" }],
        "h3-desktop": ["24px", { lineHeight: "1.25", fontWeight: "600" }],
        "h3-mobile": ["20px", { lineHeight: "1.25", fontWeight: "600" }],
